...
1. Reuse the original [MathController.cs](https://github.com/PROG7311-2026-EMWVL/MathApp/blob/main/Controllers/MathController.cs) from the original project. Add this to the `Controllers ` folder in your new project.
